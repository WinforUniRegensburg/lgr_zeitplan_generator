...
\newcommand{\titelthema}{Entwicklung eines Zeitplan-Generators für Leichtathletikveranstaltungen}
\newcommand{\authorname}{Thomas Baumer, Benedikt Bruckner}
\newcommand{\authormail}{Thomas.Baumer@stud.uni-regensburg.de, Benedikt.Bruckner@stud.uni-regensburg.de}
\newcommand{\matrikelnr}{1721141, 1728475}
\newcommand{\abgabedatum}{11. Februar 2017}
\newcommand{\betreuer}{Gerit Wagner}
\newcommand{\arbeitstyp}{Projektseminar}
...
% nur verwendete Abkürzungen werden dargestellt
  ...
  \markboth{\uppercase{Abkürzungsverzeichnis}}{}
   ...
   \renewcommand{\aclabelfont}[1]{\normalfont{\normalsize{#1}}\hfill}
      ...
      \acro{UTF-8}{8-Bit Universal Character Set Transformation Format}
...
\section{Datenmodell eines Events}
\label{sec:Datenmodell eines Events}
\begin{figure}[htbp]
  \centering
  \includegraphics[width=1.0\textwidth]{Chen_Event.png}
\end{figure}

\newpage

\section{Datentyp zur Verdeutlichung des Aufbaus der View von GenerateTable}
\label{Datentyp zur Verdeutlichung des Aufbaus der View von GenerateTable}
\begin{figure}[htbp]
  \centering
  \includegraphics[angle=90, width=0.9\textwidth]{Chen_Table.png}
\end{figure}

\chapter{Digitaler Anhang des Zeitplan-Generators}
\label{chap:Digitaler Anhang des Zeitplan-Generators} 
